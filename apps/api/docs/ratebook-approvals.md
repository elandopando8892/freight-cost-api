...
solicitante, revisor, decisión y fechas. Para `RATEWARE_DELIVERY` también
conserva el checksum exacto del paquete revisado. Solo un administrador puede
decidir y nunca puede decidir su propia solicitud.
